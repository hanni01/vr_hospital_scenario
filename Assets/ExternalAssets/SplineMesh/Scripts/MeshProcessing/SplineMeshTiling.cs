...
namespace SplineMesh {
    ...
    public class SplineMeshTiling : MonoBehaviour {
        ...
        private void OnEnable() {
            ...
            if (CoUpdateMesh != null) StopCoroutine(CoUpdateMesh);
            CoUpdateMesh = StartCoroutine(CorUpdateMesh());
        }
        ...
        IEnumerator CorUpdateMesh()
        {
            WaitForSeconds wait = new WaitForSeconds(0.5f);
            while (true)
            {
                if (!updateInPlayMode && Application.isPlaying) yield return wait;
